...
public class ROV_WithPS3 extends PApplet {
    ...
    public void drawAndDriveZ(double flZ, double frZ, double blZ, double brZ){
    ...
    public void drawAndDriveXY(double flXY,double frXY, double blXY, double brXY){
